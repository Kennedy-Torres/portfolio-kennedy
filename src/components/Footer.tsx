...
export function Footer() {
  ...
  return (
    <footer id="contato" className="w-full bg-gray-900 dark:bg-[#0a1120] text-white pt-20 pb-12 px-4 transition-colors duration-200 border-t border-gray-800 dark:border-gray-800/60">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="mb-12">
          <button
            ...
            className={`inline-flex items-center gap-3 font-semibold px-8 py-4 rounded-full transition-all duration-300 shadow-lg cursor-pointer ${
              copied 
